...
export const HeroSection = () => {
  ...
  return (
    <section className="px-6 md:px-20 pt-20 bg-[url(/assets/hero-bg.svg)] bg-cover bg-center relative">
      <div className="w-full mx-auto flex flex-row items-center justify-between gap-20 py-[50px]">
        {/* Left Text Block */}
      ...
      <Image
        className="absolute left-[450px] bottom-[-150px] z-[-1] animate-spin-slow"
